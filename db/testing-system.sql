...
IF (OBJECT_ID('dbo.Answers_Select', 'P') IS NOT NULL)
...
WHERE A.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- Groups (Select)

IF (OBJECT_ID('dbo.Groups_Select', 'P') IS NOT NULL)
...
WHERE G.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- GroupTests (Select)

IF (OBJECT_ID('dbo.GroupTests_Select', 'P') IS NOT NULL)
DROP PROCEDURE dbo.GroupTests_Select;
GO

CREATE PROCEDURE dbo.GroupTests_Select
@IsRemoved BIT = NULL
AS
BEGIN
SELECT GT.RecordId,
...
GT.[End],
GT.IsRemoved
FROM dbo.GroupTests AS GT
WHERE GT.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- Questions (Select)

IF (OBJECT_ID('dbo.Questions_Select', 'P') IS NOT NULL)
...
WHERE Q.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- Roles (Select)

IF (OBJECT_ID('dbo.Roles_Select', 'P') IS NOT NULL)
DROP PROCEDURE dbo.Roles_Select;
GO
...
R.IsRemoved
FROM dbo.Roles AS R
WHERE R.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- StudentTests (Select)

IF (OBJECT_ID('dbo.StudentTests_Select', 'P') IS NOT NULL)
DROP PROCEDURE dbo.StudentTests_Select;
GO

CREATE PROCEDURE dbo.StudentTests_Select
@IsRemoved BIT = NULL
AS
BEGIN
SELECT ST.RecordId,
...
ST.[End],
ST.IsRemoved
FROM dbo.StudentTests AS ST
WHERE ST.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- Tests (Select)

IF (OBJECT_ID('dbo.Tests_Select','P') IS NOT NULL)
DROP PROCEDURE dbo.Tests_Select;
GO

CREATE PROCEDURE dbo.Tests_Select
@IsRemoved BIT = NULL
AS
BEGIN
SELECT T.TestId,
...
T.IsRemoved
FROM dbo.Tests AS T
WHERE T.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- UserRoles (Select)

IF (OBJECT_ID('dbo.UserRoles_Select','P') IS NOT NULL)
DROP PROCEDURE dbo.UserRoles_Select;
GO

CREATE PROCEDURE dbo.UserRoles_Select
@IsRemoved BIT = NULL
AS
BEGIN
SELECT UR.UserId,
...
WHERE UR.IsRemoved = @IsRemoved OR @IsRemoved IS NULL;
END
GO

-- Users (Select)

IF (OBJECT_ID('dbo.Users_Select', 'P') IS NOT NULL)
...
U.IsRemoved
FROM dbo.Users AS U
WHERE U.UserId = @IsRemoved OR @IsRemoved IS NULL;
END
GO
